...
to Deepen's evaluate.deepen.ai for the sealed/signed version of this report.
...
# TODO(deepen-ai/deepen-grade#1): implement the real POST once evaluate.deepen.ai
...
SHARE_ENDPOINT = "https://evaluate.deepen.ai/api/v1/reports"
...
def share_report(report: dict[str, Any], dry_run_path: str | Path | None = None) -> None:
    ...
    raise ShareNotImplementedError(
        ...
        + extra
        + " Track/follow along: https://github.com/deepen-ai/deepen-grade/issues"
    )
